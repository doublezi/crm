  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">创建新的管理员</strong></div>
      </div>
...
--> 
        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          <form class="am-form am-form-horizontal" method="post" action="${pageContext.servletContext.contextPath}/sysuser/add">
            <div class="am-form-group">
              <label for="user-name" class="am-u-sm-3 am-form-label">用户名</label>
              <div class="am-u-sm-9">
                <input name="userName" type="text" id="user-name" placeholder="输入用户名（任意输入，只要你记得住） ">
                <small>创建登陆此系统的用户名</small>
              </div>
            </div>

            <div class="am-form-group">
              <label for="user-password" class="am-u-sm-3 am-form-label">输入密码</label>
              <div class="am-u-sm-9">
                <input name="userPassword" type="password" id="user-password" placeholder="输入密码">
                <small>输入你的密码</small>
              </div>
            </div>

            <div class="am-form-group">
              <label for="user-password" class="am-u-sm-3 am-form-label">再次输入密码</label>
              <div class="am-u-sm-9">
                <input type="password" id="user-password" placeholder="再次输入密码">
                <small>听话，再输入一次</small>
              </div>
            </div>
